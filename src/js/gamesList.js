...
export const gamesList = [
    ...
    new Games('Tires destroyers', 'Racing,Sports', '1-4', 6, '/images/racing.png', 'Good old racing game with no other worries than going fast!'),
    new Games('Ultime Karate Warriors', 'Adventure,Sports', '1-2', 3, '/images/karate.png', 'Free your village from the tiranny of the evil shogun'),
    ...
    new Games('Big push Sumo hero', 'fighting,Sports', '1-2', 3, '/images/sumo.PNG', 'Dive into the shady world of sumo wrestling. Where the mafia control everthing!'),
    ...
    new Games('FireBall madness', 'RPG', '1', 6, '/images/rpg_list.png', 'A long adventure where you will find your way as a wizard apprentice'),
