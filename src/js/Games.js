export class Games {
    ...
    createGamesElement() {
        ...
        gamesItem.className = 'flex flex-col text-center items-center w-[95%] font-slikScreen text-lime-950 p-5';

        const img = document.createElement('img');
        img.src = this.imageUrl;
        img.alt = this.title;
        img.className = 'w-[7rem] h-[7rem] md:w-[10rem] md:h-[10rem] lg:w-[15rem] lg:h-[15rem] md:mr-4 rounded-xl';

        const content = document.createElement('div');
        content.className = 'flex flex-col pl-5';

        const gameTitle = document.createElement('h3');
        gameTitle.className = 'text-xl font-extrabold';
        gameTitle.textContent = this.title;

        const gameType = document.createElement('p');
        gameType.className = 'text-gray-600';
        ...
        gamePrice.className = 'text-amber-500';
        ...
        addToCartButton.className = 'p-2 text-white rounded flex items-center focus:bg-green-200 focus:border-2 focus:border-lime-900';
